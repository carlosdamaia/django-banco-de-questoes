...
class QuestoesSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        'concluida', 'data_conclusao', 'alternativa_usuario', 'acertou', 'pontuacao', 'acertou', 'imagem'
        )
...
class ApresentaQuestaoSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        'texto_c', 'alt_d', 'texto_d', 'alt_e', 'texto_e', 'alt_f',
        'texto_f', 'alt_g', 'texto_g', 'alt_correta', 'concluida', 'conta_pontuacao', 'acertou', 'imagem')
